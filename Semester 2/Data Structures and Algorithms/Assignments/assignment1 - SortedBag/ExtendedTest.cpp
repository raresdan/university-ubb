...
void testMostFrequent(Relation r)
{
	cout << "Test mostFrequent" << endl;
	SortedBag sb(r);

	assert(sb.mostFrequent() == -11111);
	...
	sb.add(5);
	sb.add(7);
	assert(sb.mostFrequent() == 1);

	sb.remove(1);
	sb.remove(1);
	sb.remove(1);
	assert(sb.mostFrequent() == 5);
...
void testAllExtended() {
	...
	testMostFrequent(relation2);
	testMostFrequent(relation3);
}
