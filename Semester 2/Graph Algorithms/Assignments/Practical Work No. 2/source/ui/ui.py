from source.graph.graph import UndirectedGraph


class Ui:
    def __init__(self):
        self.graph = UndirectedGraph(0)
        self.copy = UndirectedGraph(0)
    ...
    def printVertices(self):
        vertices = list(self.graph.parseX())
        for v in vertices:
            print(v)
    ...
    def printGraph(self):
        ...
        for v in self.graph.parseX():
            print("Vertex", v, "Neighbors:", list(self.graph.parseN(v)))
    ...
    def depthFirstTraversal(self):
        ...
        for component in components:
            vertices = list(component.parseX())
            vertices.sort()
    ...
    def menu():
        ...
        print("12. Check if a vertex belongs to the graph")
        print("13. Check if an edge belongs to the graph")
        print("14. Print the list of vertices")
        print("15. Print the list of edges")
        print()
        print("READ/WRITE/COPY/PRINT GRAPH")
        print("16. Print the graph")
        print("17. Copy the graph")
        print("18. Read the graph from predefined file")
        print("19. Read the graph from written file")
        print("20. Write the graph to file")
        print("21. Revert to last copy made")
        print()
        print("DEPTH-FIRST TRAVERSAL")
        print("22. Get connected components")
        print()
        print("0. Exit")
