...
void AdministratorService::addTutorial(std::string title, std::string presenter, Duration duration, int likes, std::string link)
{
    Tutorial tutorialToAdd{ title, presenter, duration, likes, link };
    this->tutorialsRepository.addTutorial(tutorialToAdd);
}

void AdministratorService::removeTutorial(std::string title, std::string presenter)
{
    ...
    this->tutorialsRepository.removeTutorial(indexOfTutorialToRemove);
}
