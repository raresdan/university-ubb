...
Lecture10_Notepad::Lecture10_Notepad(std::string filename, QWidget* parent)
...
Lecture10_Notepad::~Lecture10_Notepad()
{

}

void Lecture10_Notepad::buildWindow()
{
...
void Lecture10_Notepad::connectSignalsAndSlots()
{
	QObject::connect(openAction, &QAction::triggered, this, &Lecture10_Notepad::open);
	QObject::connect(saveAction, &QAction::triggered, this, &Lecture10_Notepad::save);
	QObject::connect(exitAction, &QAction::triggered, QApplication::instance(), &QApplication::quit);
}

void Lecture10_Notepad::open()
{
