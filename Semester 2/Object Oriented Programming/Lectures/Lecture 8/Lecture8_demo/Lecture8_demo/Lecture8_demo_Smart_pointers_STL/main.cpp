...
//		team->addMember(m1);		// reference count for m1 is now 2, as m1 is copied into the vector
//		team->addMember(m2);		// reference count for m2 is now 2, as m2 is copied into the vector
//		team->addMember(m3);		// reference count for m3 is now 2, as m3 is copied into the vector
//
