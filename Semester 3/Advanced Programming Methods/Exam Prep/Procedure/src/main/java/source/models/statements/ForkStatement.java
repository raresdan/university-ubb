...
public class ForkStatement implements IStatement{
    ...
    public PrgState execute(PrgState currentState) throws InterpreterException {
        ...
        return new PrgState(newThreadStack, currentState.getSymbolTable(), currentState.getOutputList(),
                currentState.getFileTable(), currentState.getHeapTable(), currentState.getProcedureTable());
    }
