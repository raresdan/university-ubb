...
public class Interpreter {
    ...
    public static IStatement procedureExample(){
        return new CompoundStatement(
                new VariableDeclarationStatement("v", new IntType()),
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                ...
                                new CompoundStatement(
                                        ...
                                        new CompoundStatement(
                                                new CallProcedureStatement("sum", new ArrayList<>(Arrays.asList(new ArithmeticExpression('*', new VariableExpression("v"), new ValueExpression(new IntValue(10))), new VariableExpression("w")))),
                                                new CompoundStatement(
                                                        new PrintStatement(new VariableExpression("v")),
                                                        new ForkStatement(
                                                                new CompoundStatement(
    ...
    public static List<IStatement> getAllExamples()
    {
        ...
        allStatements.add(procedureExample());
    ...
    public void runView() {
        ...
        IStatement procedureStatement = procedureExample();
        ...
        menu.addCommand(new RunCommand("19", "Procedure Example", procedureStatement));
