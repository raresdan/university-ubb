...
public class ProgramController {
    ...
    @FXML
    private TableView<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>> semaphoreTable;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, Integer> semaphoreIndexColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, Integer> semaphoreValueColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, List<Integer>> semaphoreListColumn;
    ...
    private void initialize()
    {
        ...
        semaphoreValueColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getValue().first() - p.getValue().getValue().third()).asObject());
        semaphoreListColumn.setCellValueFactory(p -> new SimpleObjectProperty<>(p.getValue().getValue().second()));
    }
    ...
    private void populateSemaphoreTable() {
        ...
        List<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>> semaphoreTableList = new ArrayList<>();
        if (state != null) {
            MyISemaphoreTable semaphoreTbl = state.getSemaphoreTable();
            semaphoreTableList = new ArrayList<>(semaphoreTbl.getContent().entrySet());
        }
