...
public class PrgState {
    ...
    public PrgState(MyIStack<IStatement> exeStack, MyIDictionary<String, IValue> symbolTable,
                    MyIList<IValue> outputList, MyIDictionary<String, BufferedReader> fileTable, MyIHeap heapTable,  SemaphoreTable semaphoreTable) {
    ...
    public SemaphoreTable getSemaphoreTable() {return semaphoreTable;}
